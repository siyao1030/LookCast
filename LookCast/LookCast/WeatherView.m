...
- (void)setUpWithWeatherInfo:(NSDictionary *)weather
{
    //placeholder
    self.icon = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"partlycloudy.png"]];
    [self addSubview:self.icon];
    [self.icon setFrame:CGRectMake(11, 24, 45, 38)];
    
    self.high = [[UILabel alloc]initWithFrame:CGRectMake(11, 95, 42, 44)];
    [self.high setText:@"32"];
    ...
    [self.high setText:weather[@"high"]];
    [self.high setFont:[UIFont fontWithName:@"Helvetica Neue UltraLight" size:18.0]];
     */
//    self.low;
//    self.current;
//    self.location;
